...
<h1 class="w3-xxlarge w3-text-khaki" style="text-shadow:1px 1px 0 #444"><b>CAUÇÃO IMOBILIÁRIO</b></h1>
    <h1 class="w3-medium w3-text-gray">Preencher todos os campos corretamente e obrigatórios.</h1>

<div class="w3-twothird"><iframe src="caucao2.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" style="width:100%; height:735px;" frameborder="0" scrolling="auto"></iframe></div>

<div class="w3-third"><center><img src="../img/imovel.png" width="100%"></center><br><br><br></div>
</div>
