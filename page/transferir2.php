...
<div class="w3-container">
    <div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:12px; margin-top:10px;"><b>Olá <?Php echo $name; ?>,</b><br><br>
    Siga corretamente o passo a passo para transferir valores entre contas.</b><br>
</div><br>

<strong>1º Passo:</strong> Para quem você quer enviar?<br><br>
<form action="transferir_pesquisar_associado.php?id=<?Php echo $id; ?>" name="form" method="post">
<input name="limite" type="hidden" value="<?Php echo $saldoGeral; ?>">
<input name="afiliado" autocomplete="off" class="w3-input w3-border w3-round w3-padding-16" type="number" step="0.010" onpaste="return false;" placeholder="Conta sem o dígito" onkeyup="somenteNumeros(this);" style="font-size:18px; text-align:center;"><br>
