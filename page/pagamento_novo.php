...
Escolha tipo de conta à pagar.
</div>

<a href="pagamento_novo_boleto.php?id=<?Php echo $id; ?>&&empresa=<?php echo $empresa; ?>"><button name="tipo" type="button" class="w3-input btn w3-teal btn-lg" style="margin-bottom:5px; height:70px;"> Boleto Diversos</button></a>
<a href="pagamento_novo_concessionaria.php?id=<?Php echo $id; ?>&&empresa=<?php echo $empresa; ?>"><button name="tipo" type="button" class="w3-input btn w3-green btn-lg" style="margin-bottom:5px; height:70px;"> Água, Luz, Telefone, Gás</button></a>
<a href="pagamento_novo_diversos.php?id=<?Php echo $id; ?>&&empresa=<?php echo $empresa; ?>"><button name="tipo" type="button" class="w3-text-white w3-input btn w3-light-green btn-lg" style="margin-bottom:5px; height:70px;"> Cartão de Crédito ou <br>Outros Pagamentos</button></a>
