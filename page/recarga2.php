...
Nesta tela você poderá realizar solicitações de Recargas para seu celular das principais operadoras de telefonia.<br />

Após a solicitação de recargas é executada durante o dia respeitando os seguintes horários:<br>
<strong>Solicitações das 08:00 às 22:00hs, são realizadas no mesmo dia.<br>
Após as 22:00hs, próximo dia útil</strong>
</div><br>

<table style="width:100%;">
    <tr>
        <td style="width:50%; text-align:right;"><a href="realizar_consultar_recargas.php?id=<?Php echo $id; ?>"><button type="button" class="w3-input w3-blue btn-lg w3-padding-16" style="margin-bottom:5px; width:98%;"><i class="fas fa-mobile-alt"></i> Consultar Recargas</button></a></td>
        <td style="width:50%; text-align:left;"><a href="realizar_recarga_telefone.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>"><button type="button" class="w3-teal w3-input btn-lg w3-padding-16" style="margin-bottom:5px"><i class="fas fa-mobile-alt"></i>  Novo</button></a></td>
