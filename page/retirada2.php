...
<?Php
if($saldoGeral < "20"){
    echo "<h2 class='w3-large' style='text-align:center; padding-top:50px;'>PARA SOLICITAR SAQUE, PRECISA TER SALDO MÍNIMO DE R$ 20,00 DISPONÍVEL</h2>";
}elseif($solicitacoes >= $limiteSolicitacao){
    echo "<h2 class='w3-xlarge w3-padding' style='text-align:center; padding-top:50px;'>DESCULPE! VOCÊ NÃO POSSUI MAIS SOLICITAÇÕES DISPONÍVEIS PARA HOJE</h2>";
}elseif($totalSolicitado >= "5000"){
    echo "<h2 class='w3-xlarge w3-padding' style='text-align:center; padding-top:50px;'>DESCULPE! LIMITE DIÁRIO JÁ UTILIZADO!</h2>";
}else{
?>

<div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:12px; margin-top:10px;">
Olá, Sr(a) <b><?Php echo $name; ?> </b><br><br>  
<strong>* Regras para realização de DOC/TED:</strong><br />
a) Autorizado somente quando não houver débitos em abertos;<br />
b) Transferência mínima de R$ 20,00;<br />
c) Limite Total Diário: R$ 5.000,00;<br />
d) Limite de até 3 solicitações por dia;<br />
e) Tarifa de serviço por transação: R$ <?Php echo number_format($tarifaSaque,2,",",".");?>;<br>
f) Solicitações com prazo de até 48hs úteis para ser atendidas
</div><br>

<table style="width:100%;">
    <tr>
        <td style="width:50%; text-align:left;"><a href="retirar_confirmar_saque.php?favorecido=0&&id=<?Php echo $id; ?>&&limite=<?Php echo $limite; ?>&&limite2=<?Php echo '5000'; ?>&&quantidade=<?Php echo $quatidadedisponivel; ?>&&tarifa=<?Php echo $tarifa; ?>&&empresa=<?Php echo $empresa; ?>"><button type="button" class="w3-teal w3-input btn-lg w3-padding-16" style="width:100%;"><i class="fa fa-money-bill-wave"></i>  Solicitar</button></a></td>
