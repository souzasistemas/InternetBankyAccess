...
<?Php
if($verExcent['excent_afiliado_id'] == ""){
?>


<div class="w3-container">
    <div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:14px; margin-top:10px;"><b>REGRAS PARA NOVAS APLICAÇÕES</b><br><br>
    Aplicação Inicial a partir de <b>R$ 1000,00 (Mil Reais)</b>.<br>
    Basta escolher um de nossos pacotes e o valor para iniciar sua aplicação.</b></div>
...
E por estarem justos e contratados, as partes assinam o presente instrumento particular
</p>
      </div>
...
<a href="aplicacao_novo_iniciar.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>"><button class="w3-tag w3-round w3-blue w3-padding-32" style="border:0; width:100%; font-size:20px;" type="button"> Nova Aplicação</button></a>



<div class="w3-container w3-pale-yellow w3-round w3-padding-16" style="margin-top:10px;">
	<div class="w3-left"><i class="fa fa-money" aria-hidden="true" style="font-size:20px;"></i> <span style="font-size:14px;">Total Aplicado</span></div><br>
	<div style="font-size:20px; margin-top:-20px; text-align:right;">R$ <?Php echo number_format($totalValor2,2,",",".");?></div>   
</div>

<div class="w3-container w3-sand w3-round w3-padding-16" style="margin-top:2px;">
	<div class="w3-left"><i class="fa fa-money" aria-hidden="true" style="font-size:20px;"></i> <span style="font-size:14px;">Rendimento Mensal</span></div><br>
	<div style="font-size:20px; margin-top:-20px; text-align:right;">R$ <?Php echo number_format($totalValor3,2,",",".");?></div>   
</div>

<!---
<div class="w3-container w3-teal w3-text-white w3-round w3-padding-16" style="margin-top:2px;">
	<div class="w3-left"><i class="fa fa-money" aria-hidden="true" style="font-size:14px;"></i> <span style="font-size:14px;">Valor Bloqueado</span></div><br>
	<div style="font-weight:bold; font-size:14px; margin-top:-20px; text-align:right;">R$ <?Php echo number_format($totalValor4,2,",",".");?></div>   
</div>
--->

<?php
$busca = "SELECT * FROM sps_excent WHERE excent_afiliado_id='$id' AND excent_status='Ativo' ORDER BY excent_id DESC"; 
...
<div class="w3-container-fluid" style="font-size:14px; margin-top:10px;">

<table class="w3-table w3-striped w3-bordered w3-hoverable" style="width:100%;">
    <thead style="background-color:#000; color:#fff;">
        <tr>
            <th colspan="6" width="95%" style="text-align:center; vertical-align: middle;">Meus Contratos Ativos <b>(<?Php echo $totalExcent; ?>)</b></th>
        </tr>
        <tr>
            <th style="text-align:left;vertical-align: middle; width:30%;">Contrato</th>
            <th style="text-align:center;vertical-align: middle; width:15%;">Protocolo</th>
            <th style="text-align:center;vertical-align: middle; width:10%;">Aplicação</th>
            <th style="text-align:center;vertical-align: middle; width:10%;">Rendimento</th>
            <th style="text-align:center;vertical-align: middle; width:34%;">Período</th>
...
$pct = $produto['excent_plano'];
$sqlPlanos1 = mysqli_query($conexao, "SELECT * FROM sps_planos_investimentos WHERE invest_id='$pct'");
$verPlanos1 = mysqli_fetch_array($sqlPlanos1);


$percentual = $verPlanos1['invest_rendimento_mes'];
$nomePacote = $verPlanos1['invest_nome']." (".number_format(($percentual*100),2,",",".")."%)";
...
<tbody style="font-size:14px;">
    <tr>
        <td style="text-align:left; vertical-align: middle; color:#444">
            #<?Php echo $produto['excent_id']; ?> - <?Php echo $nomePacote; ?>
        </td>
        <td style="text-align:left; vertical-align: middle; color:#444">
            <?Php echo $produto['excent_protocolo']; ?>
        </td>
        <td style="text-align:center; vertical-align: middle; color:#444">
            <?Php echo number_format(($produto['excent_valor_bruto']-$produto['excent_taxa_adm']),2,",",".");?>
        </td>
        <td style="text-align:center; vertical-align: middle; color:#444">
            <?Php echo number_format(($produto['excent_valor_liquido']*$percentual),2,",",".");?>
        </td>
        <td style="text-align:center; vertical-align: middle; color:#444">
            <?Php echo $produto['excent_data_iniciar'];?> à 
            <?Php echo $produto['excent_data_resgate'];?>
        </td>
        
        <td style="text-align:center; vertical-align: middle;"><a href="aplicacao_ver_contrato.php?id=<?Php echo $id; ?>&&contrato=<?Php echo $produto['excent_id']; ?>&&empresa=<?Php echo $empresa; ?>"><img src="../img/icon_relatorio.png" width="20px" /></a></td>
