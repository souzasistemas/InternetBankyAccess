...
<script>
jQuery(function($){
   $("#1").mask("99999999999-9",{placeholder:""});
   $("#2").mask("99999999999-9",{placeholder:""});
   $("#3").mask("99999999999-9",{placeholder:""});
   $("#4").mask("99999999999-9",{placeholder:""});
});
</script>
...
<div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:12px; margin-bottom:10px;"><b>Olá <?Php echo $name; ?> </b><br>
<b>Tipo de Pagamento: </b>Água, Luz, Telefone, Gás
</div>
...
<input type="tel" id="1" onkeyup="conta(this)" maxlength="13" class="w3-input" name="linha1" placeholder="1ª Parte do Código" style="text-align:center; font-family:arial;"  />	
<input type="tel" id="2" onkeyup="conta(this)" maxlength="13" class="w3-input" name="linha2" placeholder="2ª Parte do Código" style="text-align:center; font-family:arial;"  />		
<input type="tel" id="3" onkeyup="conta(this)" maxlength="13" class="w3-input" name="linha3" placeholder="3ª Parte do Código" style="text-align:center; font-family:arial;"  />	
<input type="tel" id="4" maxlength="13" class="w3-input" name="linha4" placeholder="4ª Parte do Código" style="text-align:center; font-family:arial;"  />	
