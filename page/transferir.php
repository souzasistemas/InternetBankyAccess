...
<h1 class="w3-xxlarge w3-text-khaki" style="text-shadow:1px 1px 0 #444"><b>TRANSFERÊNCIA ENTRE CONTAS</b></h1>

<div class="w3-twothird"><iframe src="transferir2.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" style="width:100%; height:400px;" frameborder="0" scrolling="no"></iframe></div>

<div class="w3-third"><center><img src="../img/transferir.png" width="100%"></center><br><br><br></div>
</div>
