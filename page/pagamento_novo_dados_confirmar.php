...
<div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:12px; margin-top:10px; margin-bottom:10px;"><b>Olá <?Php echo $name; ?>,</b><br><br>
<b>Tipo de Pagamento: </b><?Php echo $nomeBoleto2; ?><br>
<b>Código de Barras:</b><br> <?Php echo $codigo; ?><br>
<b>Valor: </b>R$ <?Php echo number_format($valor,2,",","."); ?><br>
<b>Vencimento: </b> <?Php echo $vencimento; ?><br>
<b>Descrição: </b> <?Php echo $descricao; ?><br>
</div>
<b>3º Passo:</b> Se os dados acima estão corretos?<br><br>

<form action="pagamento_novo_dados_inserir.php?id=<?Php echo $id; ?>&&empresa=<?php echo $empresa; ?>" method="post" name="form">
    <input name="tipo" type="hidden" value="<?Php echo $tipo; ?>">
    <input name="codigo" type="hidden" value="<?Php echo $codigo;?>">
    <input name="valor" type="hidden" value="<?Php echo $valorCrypt;?>">
    <input name="data" type="hidden" value="<?Php echo $vencimento;?>">
    <input name="descricao" type="hidden" value="<?Php echo $descricao;?>">
   
 
    <input name="senha" id="pass" type="password" class="form-control input-lg w3-padding-16" autocomplete="off" placeholder="Digite aqui seu PIN" maxlength="4" style="text-transform:uppercase; margin-top:2px;font-family:Trebuchet MS, sans-serif; width:92%; text-align:center;">
 ...
 <table style="width:100%;">
    <tr>
        <td style="width:50%; text-align:right;"><a href="pagamento2.php?id=<?Php echo $id; ?>"><button type="button" class="w3-input w3-red btn-lg w3-padding-8"  style="margin-bottom:5px; width:98%;"><i class="fas fa-reply"></i> Cancelar</button></a></td>
        <td style="width:50%; text-align:left;"><button type="submit" name="Submit" class="w3-input w3-teal btn-lg w3-padding-8" style="margin-bottom:5px;  width:100%;" /><i class="fas fa-check"></i> Efetuar</button></td>
