...
<div class="w3-container">
    ...
    Envie o comprovante de seu depósito para que em até <b>1H</b> seu saldo seja liberado em sua conta.
    </div>
<?Php
...
<div  style="border-radius:5px; margin-top:20px; text-align:center;">
<form action="deposito_enviar_comprovante.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" method="post" enctype="multipart/form-data" name="email">

<input type="hidden" name="nome" value="<?Php echo $nome;?> <?Php echo $sobrenome;?>">
<input type="hidden" name="assunto"  value="Comprovante de depósito - Empresa <?Php echo $empresa;?> - <?Php echo strtoupper($verEmpresa['logo_fantasia']); ?>">
<input type="hidden" name="mensagem"  value="Segue em anexo o comprovante de depósito">
<input name="arquivo" type="file" class="w3-input w3-white btn-lg w3-padding-16 w3-border" style="margin-bottom:5px; border:1px solid #ccc;">
<button type="submit" class="w3-input w3-green btn-lg w3-padding-16" style="margin-bottom:5px;" /><i class="fas fa-angle-right"></i> Enviar</button>
<a href="deposito_banco2.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>"><button type="button" class="w3-input w3-red btn-lg w3-padding-16" style="margin-bottom:5px;" /><i class="fas fa-reply"></i> Início</button></a>
</form>
</div>
