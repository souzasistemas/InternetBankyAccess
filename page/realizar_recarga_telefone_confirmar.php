...
if($operadora == "OI"){
	$valor = $_POST['valorOi'];
	$simbolo = "<img src='../img/logo_oi.png' width='30' />";
}elseif($operadora == "TIM"){
	$valor = $_POST['valorTim'];
	$simbolo = "<img src='../img/logo_tim.png' width='60' />";
}elseif($operadora == "CLARO"){
	$valor = $_POST['valorClaro'];
	$simbolo = "<img src='../img/logo_claro.png' width='40' />";
}elseif($operadora == "VIVO"){
	$valor = $_POST['valorVivo'];
	$simbolo = "<img src='../img/logo_vivo.png' width='40' />";
}elseif($operadora == "NEXTEL"){
	$valor = $_POST['valorNextel'];
	$simbolo = "<img src='../img/logo_nextel.png' width='60' />";
}
?>

<div class="w3-text-gray w3-light-gray w3-padding w3-round w3-border" style="font-size:12px; "><b>Olá <?Php echo $name; ?>,</b><br>
Recargas realizadas entre 08:00hs até às 22:00hs, serão realizadas no mesmo dia;<br />
Após as 22:00hs, serão realizadas no próximo dia à partir das 08:00hs;<br /><br />
<b>Telefone à ser carregado:</b>  <?Php echo $celular; ?><br />
<b>Valor da Recarga:</b>  <?Php echo "R$ " .number_format($valor,2,",","."); ?> <br>
<?Php echo $simbolo; ?>
</div><br> 

<b>Para efetuar sua solicitação, digite seu PIN</b>

<form action="realizar_recarga_telefone_efetuar.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" name="form" method="post">
<input type="hidden" name="valor" value="<?Php echo $valor; ?>">
<input type="hidden" name="operadora" value="<?Php echo $operadora; ?>">
<input type="hidden" name="numero" value="<?Php echo $celular; ?>">
<input name="senha" id="pass" type="password" class="form-control input-lg w3-padding-16" autocomplete="off" placeholder="Digite aqui seu PIN" maxlength="4" style="text-align:center; text-transform:uppercase; margin-top:2px;font-family:Trebuchet MS, sans-serif; width:91%;">
    <input type="tel" style="border:none;" class="form-control ng-valid-minlength ng-dirty ng-valid ng-valid-required" id="passReal" name="passReal" required="" data-ng-minlength="4" maxlength="4" data-display-error-onblur="" data-number-mask="telephone" tabindex="5">
     <br><br> <br>
     
<table style="width:100%;">
    <tr>
        <td style="width:50%; text-align:right;"><a href="recarga.php?id=<?Php echo $id; ?>"><button type="button" class="w3-input w3-red btn-lg w3-padding-16" style="margin-bottom:5px; width:98%;"><i class="fas fa-reply"></i> Cancelar</button></a></td>
