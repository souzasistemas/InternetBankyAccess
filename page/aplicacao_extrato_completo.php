...
<hr class="w3-margin" style="margin:0; padding:0;">
<b>Legenda:</b><br>
    B - Bloqueado &nbsp;&nbsp;
    R - Resgatado &nbsp;&nbsp;
    A - Aplicado </b>
...
<?Php
$sqlExtrato = mysqli_query($conexao, "SELECT * FROM sps_excent_residual WHERE residual_afiliado_id='$id' GROUP BY residual_contrato ORDER BY residual_id DESC");
while($verExtrato = mysqli_fetch_array($sqlExtrato)){
    $idContrato = $verExtrato['residual_contrato'];
    
$sqlPac = mysqli_query($conexao, "SELECT * FROM sps_excent WHERE excent_id='$idContrato'");
...
<tr>
<th colspan="3" class="w3-yellow w3-center w3-padding"><b>Contrato #</b><?Php echo $idContrato; ?> <br> <?Php echo $nomePacote; ?></th>
</tr>
<tr>
...
<?Php
$sqlExtrato2 = mysqli_query($conexao, "SELECT * FROM sps_excent_residual WHERE residual_afiliado_id='$id' AND residual_contrato='$idContrato' ORDER BY residual_id DESC");
while($verExtrato2 = mysqli_fetch_array($sqlExtrato2)){
?>
...
<tr>
                ...
                <td style="text-align:right; vertical-align:middle; font-size:10px;"><?Php echo number_format($verExtrato2['residual_valor'],2,",","."); ?></td>
...
<?Php
$sqlExtrato2 = mysqli_query($conexao, "SELECT sum(residual_valor) FROM sps_excent_residual WHERE residual_afiliado_id='$id' AND residual_contrato='$idContrato'");
...
?>
<br><br>
<a href="aplicacao.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>"><div class="w3-padding-16 w3-orange w3-round w3-text-white w3-center" style="width:100%; text-align:left; margin-top:2px;"><i class="fa fa-reply" style="font-size:20px;"></i> <b style="font-size:18px;"> Minhas Aplicações</b>
