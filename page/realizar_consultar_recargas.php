...
Segue abaixo suas recargas solicitadas
</div><br>
...
<table class="table table-condensed">
    <thead style="background-color:#000; color:#fff;">
        <tr>
            <th width="15%" style="text-align:center; vertical-align: middle;">Solicitado</th>
            <th width="30%" style="text-align:center; vertical-align: middle;">Número</th>
            <th width="15%" style="text-align:center; vertical-align: middle;">Valor</th>
            <th width="10%" style="text-align:center; vertical-align: middle;">Status</th>
        </tr>
    </thead>
    
<?Php
$sqlBusca = mysqli_query($conexao, "SELECT * FROM sps_recarga_celular WHERE recarga_afiliado_id='$id' ORDER BY recarga_id DESC LIMIT 30");
while($produto = mysqli_fetch_assoc($sqlBusca)) {
?>
...
<tbody style="font-size:12px;">
    <tr>
        <td style="text-align:center; vertical-align: middle;">
            <?php echo $produto['recarga_dia']; ?>/<?php echo $produto['recarga_mes']; ?>/<?php echo $produto['recarga_ano']; ?><br>
        <?php echo $produto['recarga_hora']; ?></td>
        <td style="text-align:center; vertical-align: middle;"><?php echo $produto['recarga_numero']; ?><br>
        ...
        <td style="text-align:center; vertical-align: middle;"><?php echo number_format($produto['recarga_valor'],2,",","."); ?></td>
        <td style="text-align:center; vertical-align: middle;"><?php echo $produto['recarga_status']; ?></td>
    </tr>
</tbody>
<?Php
}
