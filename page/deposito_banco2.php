...
<div class="w3-container">
    ...
    Para realizar depósito via Transferência, insira o valor para aparecer as informações da conta para transferencia.<br><br>
    <b style="color:gray;">* Após a realização do depósito, enviar o comprovante utilizando a opção abaixo</b>
    </div>
    
<div  style="border-radius:5px; margin-top:10px; text-align:center;">
<form action="deposito_banco_efetuar.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" name="form" method="post">
...
<input name="valor" id="input" class="w3-input w3-border w3-round w3-padding-16" type="number" step="0.010"  placeholder="Valor para depósito" autocomplete="off" style="font-size:18px; margin-bottom:5px; text-align:center;" required></center>
