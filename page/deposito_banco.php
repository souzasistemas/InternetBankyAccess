...
<h1 class="w3-xxlarge w3-text-khaki" style="text-shadow:1px 1px 0 #444"><b>DEPÓSITO VIA TRANSFERÊNCIA</b></h1>

<div class="w3-twothird"><iframe src="deposito_banco2.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>" style="width:100%; height:500px;" frameborder="0" scrolling="no"></iframe></div>

<div class="w3-third"><center><img src="../img/deposito.png" width="100%"></center><br><br><br></div>
</div>
