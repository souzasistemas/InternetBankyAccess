...
require "../../../../../config/config.php";
		...
		$arquivo = 'investteam_conta_internetbank.xls';
		...
		$conta = $_GET['id'];
		$resultado_msg_contatos = mysql_query("SELECT * FROM sps_excent WHERE excent_afiliado_id='$conta' ORDER BY excent_id DESC");
		...
		while($row_msg_contatos = mysql_fetch_array($resultado_msg_contatos)){
			...
			$html .= '<td>'.number_format($row_msg_contatos['excent_valor_real'] * $row_msg_contatos['excent_percentual'],2,",",".").'</td>';
