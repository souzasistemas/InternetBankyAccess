...
$verEmpresa = mysql_fetch_array($sqlEmpresa);
    if($verEmpresa['afiliado_conta_modo'] == "Fisica"){
		...
		$arquivo = $nomeEmpresa .'_INVESTIMENTOS.xls';
		
		// Criamos uma tabela HTML com o formato da planilha
		$html = '<meta charset="utf-8">';
		$html .= '<table border="1">';
		$html .= '<tr>';
		$html .= '<td colspan="17" style="color:#fff;" align="center" bgcolor="black"><b>RELATÓRIO '.$nomeempresa.' - INVESTIMENTOS</b></tr>';
		$html .= '</tr>';
		...
		$html .= '<td rowspan="2" bgcolor="YELLOW"><b>País</b></td>';
		...
		$html .= '<td rowspan="2" bgcolor="YELLOW"><b>Plano</b></td>';
		...
		while($row_msg_contatos = mysql_fetch_array($resultado_msg_contatos)){
			...
			$html .= '<td>'.$produto.'<b>P: '.$row_msg_contatos['excent_protocolo'].'</b></td>';
