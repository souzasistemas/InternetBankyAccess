...
$residual1 = $_POST['residual1'];
$rendimento = $_POST['rendimento'];
$rendimento1 = $_POST['rendimento1'];
$descricao = $_POST['descricao'];

$insert = mysql_query("INSERT INTO sps_rendimento(
    rendimento_afiliado_id,
    redimento_correspondente_id,
    rendimento_residual_afiliado_id,
    rendimento_residual_correspondente_id,
    rendimento_investimento,
    rendimento_valor,
    rendimento_valor_correspondente,
    rendimento_descricao,
    rendimento_status,
    rendimento_modo_afiliado,
    rendimento_modo_correspondente) VALUES(
        '$id',
        '$id2',
        '$residual',
        '$residual1',
