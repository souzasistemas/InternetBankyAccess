...
<center>
<h2 class="w3-jumbo">Excluir Contrato</h2>
...
$id2 = $ver['rendimento_afiliado_id'];
...
?>
  <p>Deseja realmente excluir o contrato <b><?Php echo $id; ?></b> do Associado 
  
  <h3><?Php echo $id2; ?> - <?Php echo $nome; ?></h3></p> 
  
  <a href="investmundi_excluir_efetuar.php?id=<?Php echo $id; ?>"><button type="button" class="btn btn-success btn-lg">Sim</button></a> | 
