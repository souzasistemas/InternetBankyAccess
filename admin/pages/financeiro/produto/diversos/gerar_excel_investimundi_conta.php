...
require "../../../config/config.php";
		...
		$arquivo = 'investimundi_conta_acessomundi_bank.xls';
		...
		$conta = $_GET['id'];
		$resultado_msg_contatos = mysql_query("SELECT * FROM sps_rendimento WHERE rendimento_afiliado_id='$conta' ORDER BY rendimento_id DESC");
