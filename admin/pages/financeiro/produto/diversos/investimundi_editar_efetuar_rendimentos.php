...
$id = $_POST['id'];
$residualCrypt = $_POST['residual_investidor'];
$residualCrypt1 = $_POST['residual_correspondente'];
$status = $_POST['status'];
...
$valor = $ver['rendimento_investimento'];
...
$insert = mysql_query("UPDATE sps_rendimento SET rendimento_residual_afiliado_id='$residual', rendimento_residual_correspondente_id='$residual1', rendimento_valor='$rendimento', rendimento_valor_correspondente='$rendimento1', rendimento_status='$status' WHERE rendimento_id='$id'");

if($insert == "1"){
    echo "<h1 class='h3-jumbo'>Investidor editado com sucesso.</h1><br><br>";
	echo "<a href='investmundi.php'><button type='button' class='btn btn-info btn-lg'>Ver Investidores</button></a>";  
}else{
    echo "<script>history.back(-1);alert('Não foi possível realizar o editar do Investidor! Entrar em contato com o Suporte!');</script>";
}
?>
</center>
