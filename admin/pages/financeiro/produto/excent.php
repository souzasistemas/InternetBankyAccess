...
<h2 class="w3-xlarge w3-center"><b>RELATÓRIO DE CONTRATOS DE INVESTIMENTOS</b></h2>
...
<div class="w3-container" style="margin-bottom:20px;">
    <div class="w3-quarter">
        ...
        <a href="excent_novo.php?id=<?Php echo $id; ?>"><button class="w3-tag w3-round w3-blue w3-border w3-border-white w3-padding-16" type="button" style="width:100%;"><i class="fa fa-money" aria-hidden="true" style="font-size:30px;"></i> <br> Novo Contrato</button></a>
        </div>
    </div>
    <div class="w3-quarter">
        <div class="w3-round w3-orange" style="padding:3px; width:98%; text-align:center; margin-bottom:5px;">
        <a href="excent_novo_rendimento.php?emp=<?php echo $emp; ?>&&id=<?Php echo $id; ?>"><button class="w3-tag w3-round w3-orange w3-text-white w3-border w3-border-white w3-padding-16" type="button" style="width:100%;"><i class="fa fa-money" aria-hidden="true" style="font-size:30px;"></i> <br>Inserir Rendimento</button></a>
        </div>
    </div>
    <div class="w3-quarter">
        <div class="w3-round w3-red" style="padding:3px; width:98%; text-align:center; margin-bottom:5px;">
        <a href="excent_vencimento_mes.php?emp=<?php echo $emp; ?>&&id=<?Php echo $id; ?>"><button class="w3-tag w3-round w3-red w3-text-white w3-border w3-border-white w3-padding-16" type="button" style="width:100%;"><i class="fa fa-money" aria-hidden="true" style="font-size:30px;"></i> <br>Contratos Mês Atual</button></a>
        </div>
    </div>
    <div class="w3-quarter">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="form">
                ...
                <div class="w3-half">
                <div class="input-group input-group-lg" style="width:99%; margin-bottom:10px;">
                ...
                <div class="w3-half">
                <div class="input-group input-group-lg" style="width:99%">
...
<div class="w3-container-fluid well" style="font-size:12px;">
    <?Php
    $sqlAplicacao = mysql_query("SELECT * FROM sps_excent WHERE excent_empresa='$emp'");
    $totalAplicacao = mysql_num_rows($sqlAplicacao);
    
    $sqlAplicacao2 = mysql_query("SELECT sum(excent_valor_bruto), sum(excent_taxa_adm), sum(excent_valor_liquido), sum(excent_valor_residual) FROM sps_excent WHERE excent_empresa='$emp'");
    $verAplicacao2 = mysql_fetch_array($sqlAplicacao2);
    ?>
    <table class="w3-table" style="width:100%">
        <tr>
            <td style="text-align:left; vertical-align:middle;"><b>Total Contratos (<?Php echo $totalAplicacao; ?>)</b></td>
            <td style="text-align:right; vertical-align:middle;">R$ <?php echo number_format($verAplicacao2['sum(excent_valor_bruto)'],2,",",".");?></td>
        </tr>
        <tr>
            <td style="text-align:left; vertical-align:middle;"><b>Rendimento Mês</b></td>
...
if($contrato == "" && $conta == ""){
$busca = "SELECT * FROM sps_excent WHERE excent_empresa='$emp' ORDER BY excent_id DESC"; 
    ...
    <tr>
        ...
        <?Php
               ...
               <?Php
                     ...
                     ?>
               <a href="excent_editar.php?id=<?php echo $produto['excent_id']; ?>&&emp=<?php echo $id; ?>" data-toggle="tooltip" title="Editar Contato <?php echo $produto['excent_id']; ?>"><span class="glyphicon glyphicon-file" style="font-size:25px;color:#FFA500;"></span></a>         
               <a href="excent_extrato.php?id=<?php echo $produto['excent_id']; ?>&&emp=<?php echo $id; ?>" data-toggle="tooltip" title="Visualizar Rendimentos <?php echo $produto['excent_id']; ?>"><span class="glyphicon glyphicon-list-alt" style="font-size:25px;color:blue;"></span></a>
...
$busca = "SELECT * FROM sps_excent WHERE excent_id='$contrato' AND excent_empresa='$emp' ORDER BY excent_id DESC";
...
$busca = "SELECT * FROM sps_excent WHERE excent_afiliado_id='$conta' AND excent_empresa='$emp' ORDER BY excent_id DESC"; 
