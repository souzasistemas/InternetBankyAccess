...
<div class="w3-sidebar w3-bar-block" style="width:20%"> 
  ...
  <a class="w3-bar-item w3-button" style="display:block;" href="debito_retirar_valor.php" target="ver_relatorio"><i class="glyphicon glyphicon-usd" aria-hidden="true"></i> Retirar Valor</a>
</div>
