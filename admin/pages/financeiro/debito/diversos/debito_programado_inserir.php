...
<div class="col-sm-8">
    ...
    <div class="well" style="background-color:#cfcfcf;"><span style="font-size:20px;">Débito Programado</span></div>
<?php
...
$insertComissao = mysql_query("INSERT INTO sps_patrocinio(pi_afiliado_id, pi_patrocinador_id, pi_valor, pi_status, pi_descricao) VALUES ('$id', '4', '$valor', 'Pendente', '$descricao')", $ellevar);


if($insertComissao == '1'){
	echo "<h2>Débito agendado com sucesso!</h2><br>";
	echo"<a href='debito.php'><button name='limpar' class='btn btn-primary btn-sm' type='button'>Novo Débito Programado</button></a>";
}else{
