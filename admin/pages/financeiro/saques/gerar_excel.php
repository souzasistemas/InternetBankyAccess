...
require "../../../../../config/config.php";  
		...
		$arquivo = 'saques_acessomundi_bank.xls';
		
		// Criamos uma tabela HTML com o formato da planilha
		$html = '<meta charset="utf-8">';
		$html .= '<table border="1">';
		$html .= '<tr>';
		$html .= '<td colspan="8" align="center"><b>Relatório de Saques Pendentes</b></tr>';
		$html .= '</tr>';
		...
		$resultado_msg_contatos = mysql_query("SELECT * FROM sps_extrato WHERE extrato_status_saque='Pendente' ORDER BY extrato_id ASC");
