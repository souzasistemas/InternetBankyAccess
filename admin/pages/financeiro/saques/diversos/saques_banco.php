...
$busca = "SELECT * FROM sps_extrato WHERE extrato_status_saque='Pendente' AND extrato_modo_saque='Transferência Bancária' ORDER BY extrato_id ASC"; 
    ...
    <tr>
        ...
        <td style="text-align:right;">
            ...
            <form action="saques.php" method="post" name="form">
                ...
                <div class="w3-tag w3-round w3-green" style="padding:3px">
                 <a href="gerar_excel_banco.php"><button class="w3-tag w3-round w3-green w3-border w3-border-white" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Gerar Excell Banco</button></a>
                </div>
