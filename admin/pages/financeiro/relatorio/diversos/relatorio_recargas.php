...
<div class="col-sm-12" style="height:100px; margin-top:10px;">
    ...
    <div class="w3-twothird" style="padding:10px; vertical-align:middle; font-size:12px;">
        <h2 class="w3-xxx-large"><center>RELATÓRIO DE RECARGAS DE CELULARES REALIZADAS</center></h2> 
    </div>
</div>
...
$busca = "SELECT * FROM sps_recarga_celular WHERE recarga_status='Realizado' ORDER BY recarga_id DESC"; 
...
<table class="w3-table-all w3-hoverable" width="100%" style="font-size:12px;">
        <thead>
            <tr>
                <th class="w3-black" style="width:10%; text-align:center;">Conta</th>
                <th class="w3-black" style="width:30%; text-align:left;">Nome Associado</th>
                <th class="w3-black" style="width:10%; text-align:center;">Data</th>
                <th class="w3-black" style="width:10%; text-align:center;">Hora</th>
                <th class="w3-black" style="width:15%; text-align:center;">Número</th>
                <th class="w3-black" style="width:15%; text-align:center;">Operadora</th>
                <th class="w3-black" style="width:10%; text-align:right;">Valor</th>
            </tr>
        </thead>
<?Php
...
?>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['recarga_dia']; ?>/<?Php echo $produto['recarga_mes']; ?>/<?Php echo $produto['recarga_ano']; ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['recarga_hora']; ?></td>
		...
		if($produto['recarga_operadora'] == "CLARO"){
			echo "<img src='../../../img/logo_claro.png' width='20px'>";
		}elseif($produto['recarga_operadora'] == "TIM"){
			echo "<img src='../../../img/logo_tim.png' width='40px'>";
		}elseif($produto['recarga_operadora'] == "VIVO"){
			echo "<img src='../../../img/logo_vivo.png' width='35px'>";
		}elseif($produto['recarga_operadora'] == "OI"){
			echo "<img src='../../../img/logo_oi.png' width='20px'>";
		}elseif($produto['recarga_operadora'] == "NEXTEL"){
			echo "<img src='../../../img/logo_nextel.png' width='50px'>";
		}
		?>    
                </td>
...
$busca = "SELECT * FROM sps_recarga_celular WHERE recarga_status='Realizado' AND recarga_afiliado_id='$id' ORDER BY recarga_id DESC"; 
