...
<div class="w3-container">
    <h2 class="w3-xlarge botao">Gerar Relatório Mensal</h2>
...
<table class="w3-table">
    <tr>
        <td></td>
        <td class="w3-right" style="text-transform:uppercase"><h2>Relatório Mensal - REF: <?Php echo $mes; ?>/<?Php echo $ano; ?></h2></td>
    </tr>
</table>
...
<table class="w3-table w3-striped w3-bordered" style="font-size:10px;">
    ...
    $sql = mysql_query("SELECT * FROM sps_afiliados WHERE afiliado_id >= '986261' ORDER BY afiliado_id");
