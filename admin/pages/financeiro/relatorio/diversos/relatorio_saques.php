...
<div class="col-sm-12" style="height:100px; margin-top:10px;">
    ...
    <div class="w3-twothird" style="padding:10px; vertical-align:middle; font-size:12px;">
        <h2 class="w3-xxx-large"><center>RELATÓRIO DE SAQUES REALIZADOS</center></h2> 
    </div>
</div>
...
$busca = "SELECT * FROM sps_extrato WHERE extrato_status_saque='Pago' ORDER BY extrato_id DESC"; 
...
<table class="w3-table-all w3-hoverable" width="100%" style="font-size:12px;">
        <thead>
            <tr>
                ...
                <th class="w3-black" style="width:30%; text-align:left;">Descrição</th>
...
?>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:left; vertical-align:middle;"><?Php echo strtoupper($produto['extrato_descricao']); ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['extrato_dia']; ?>/<?Php echo $produto['extrato_mes']; ?>/<?Php echo $produto['extrato_ano']; ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['extrato_hora']; ?></td>
...
$busca = "SELECT * FROM sps_extrato WHERE extrato_status_saque='Pago' AND extrato_afiliado_id='$id' ORDER BY extrato_id DESC"; 
