...
<table class="w3-table">
    <tr>
        <td></td>
       <td class="w3-right" style="text-transform:uppercase"><h2>Relatório Anual Associado <br><?Php echo $associado; ?> - <?Php echo strtoupper($verAssociado['afiliado_nome']); ?> - REF: <?Php echo $mes; ?>/<?Php echo $ano; ?></h2></td>
