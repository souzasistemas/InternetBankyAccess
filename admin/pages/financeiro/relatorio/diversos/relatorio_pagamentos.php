...
<div class="col-sm-12" style="height:100px; margin-top:10px;">
    ...
    <div class="w3-twothird" style="padding:10px; vertical-align:middle; font-size:12px;">
        <h2 class="w3-xxx-large"><center>RELATÓRIO DE PAGAMENTOS DE CONTAS REALIZADAS</center></h2> 
    </div>
</div>
...
<table class="w3-table" width="100%">
    <tr>
        ...
        <td width="300px"><input name="id" type="text" placeholder="Nº da Conta" class="w3-input w3-white w3-round w3-border"></td>
...
$busca = "SELECT * FROM sps_pagamentos WHERE pag_status='Realizado' ORDER BY pag_id DESC"; 
...
<table class="w3-table-all w3-hoverable" width="100%" style="font-size:12px;">
        <thead>
            <tr>
                ...
                <th class="w3-black" style="width:15%; text-align:left;">Nome Associado</th>
                <th class="w3-black" style="width:15%; text-align:center;">Tipo</th>
                <th class="w3-black" style="width:25%; text-align:center;">Código de Barras</th>
                <th class="w3-black" style="width:15%; text-align:center;">Pagamento efetuado em</th>
                <th class="w3-black" style="width:5%; text-align:right;">Valor</th>
                <th class="w3-black" style="width:10%; text-align:center;">Autenticação</th>
...
?>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['pag_tipo']; ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['pag_codigo']; ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['pag_dia_pagamento']; ?>/<?Php echo $produto['pag_mes_pagamento']; ?>/<?Php echo $produto['pag_ano_pagamento']; ?><br> às <?Php echo $produto['pag_hora_pagamento']; ?></td>
                <td style="text-align:right; vertical-align:middle;"><?Php echo number_format($produto['pag_valor'],2,",","."); ?></td>
                <td style="text-align:center; vertical-align:middle;"><?Php echo $produto['pag_obs']; ?></td>
                <td style="text-align:right; vertical-align:middle;">
                    <a class="botao" href="relatorio_pagamentos_comprovante.php?codigo=<?php echo $produto['pag_id']; ?>" title="imprimir Comprovante"><i class="fa fa-print" style="color:green; font-size:30px;" aria-hidden="true"></i></a>
                </td>
            </tr>
        </tbody>
...
$busca = "SELECT * FROM sps_pagamentos WHERE pag_status='Realizado' AND pag_afiliado_id='$id' ORDER BY pag_id DESC"; 
