...
<div class="w3-container">
    <h2 class="w3-xlarge botao">Gerar Relatório Associado Mensal</h2>
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" name="form" method="POST" class="botao">
    ...
    <table class="w3-table" style="width:800px">
        <tr>
            <td style="vertical-align:middle;"><b>Conta Associado:</b> </td>
            <td><input name="associado" type="text" class="w3-input w3-white w3-round w3-border" style="width:100px"></td>
            <td style="vertical-align:middle;"><b>Mês</b> </td>
            <td><select name="mes" class="w3-input w3-white w3-round w3-border" style="width:150px">
                    <option value=""></option>
...
$sqlAssociado = mysql_query("SELECT * FROM sps_afiliados WHERE afiliado_id='$associado'");
...
<table class="w3-table">
    <tr>
        <td></td>
        <td class="w3-right" style="text-transform:uppercase"><h2>Relatório Mensal Associado <br><?Php echo $associado; ?> - <?Php echo strtoupper($verAssociado['afiliado_nome']); ?> - REF: <?Php echo $mes; ?>/<?Php echo $ano; ?></h2></td>
    </tr>
</table>
...
<table class="w3-table w3-striped w3-bordered" style="font-size:10px;">
    <thead style="background-color:#000; color:#fff;">
        ...
        <tr>
            ...
            <td style="text-align:center; width:0.5%;"> | </td>
            <td style="text-align:right; width:1%;">IRFF</td>
        </tr>
    </thead>
    
    <?Php
    
    $sql = mysql_query("SELECT * FROM sps_afiliados WHERE afiliado_id='$associado'");
        ...
        <tr>
            ...
            ?>
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada1 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Ativacao' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada2 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Recarga' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada3 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Comissao' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada4 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Residual' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada5 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Transferencia' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlEntrada6 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Taxa' AND extrato_tipo='Credito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $sqlSaida1 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Retirada' AND extrato_tipo='Debito' AND extrato_protocolo!=''");
                        $verSaida1 = mysql_fetch_array($sqlSaida1);
                            $totalRetirada2 = $verSaida1['sum(extrato_valor)'];
                        
                        $sqlSaida2 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_modulo='Transferencia' AND extrato_tipo='Debito'");
                        $verSaida2 = mysql_fetch_array($sqlSaida2);
                            $totalTransferencia2 = $verSaida2['sum(extrato_valor)'];
                            
                        $sqlSaida3 = mysql_query("SELECT sum(pag_valor) FROM sps_pagamentos WHERE pag_afiliado_id='$id' AND pag_mes_pagamento='$mes' AND pag_ano_pagamento='$ano' AND pag_status!='Cancelado'");
                        $verSaida3 = mysql_fetch_array($sqlSaida3);
                            $totalBoleto = $verSaida3['sum(pag_valor)'];
                        
                        $sqlSaida4 = mysql_query("SELECT sum(recarga_valor) FROM sps_recarga_celular WHERE recarga_afiliado_id='$id' AND recarga_mes='$mes' AND recarga_ano='$ano' AND recarga_status!='Cancelado'");
                        $verSaida4 = mysql_fetch_array($sqlSaida4);
                            $totalRecargaCelular = $verSaida4['sum(recarga_valor)'];
                            
                        $sqlSaida5 = mysql_query("SELECT sum(movimento_valor) FROM sps_movimentacao WHERE movimento_afiliado_id='$id' AND movimento_mes='$mes' AND movimento_ano='$ano' AND movimento_tipo='Venda'");
                        $verSaida5 = mysql_fetch_array($sqlSaida5);
                            $totalMovimentacao1 = $verSaida5['sum(movimento_valor)'];
                            
                        $sqlSaida5a = mysql_query("SELECT sum(movimento_valor) FROM sps_movimentacao_credito WHERE movimento_afiliado_id='$id' AND movimento_mes='$mes' AND movimento_ano='$ano' AND movimento_tipo='Venda'");
                        ...
                        $sqlSaida6 = mysql_query("SELECT sum(extrato_valor) FROM sps_extrato WHERE extrato_afiliado_id='$id' AND extrato_mes='$mes' AND extrato_ano='$ano' AND extrato_tipo='Debito'");
                ...
                <td style="text-align:right; vertical-align:middle;">
                    <?Php
                        $totalEntrada = $totalAtivacao + $totalRecarga + $totalResidual + $totalTransferencia + $totalComissao + $totalTaxas;
                        
                        if($totalEntrada < '1903.99'){
                            $imposto = "0";
                        }elseif($totalEntrada >= '1903.99' && $totalEntrada < '2826.66'){
                            $imposto = ($totalEntrada - 142.80) * 0.075;
                        }elseif($totalEntrada >= '2826.66' && $totalEntrada < '3751.06'){
                            $imposto = ($totalEntrada - 354.80) * 0.15;
                        }elseif($totalEntrada >= '3751.06' && $totalEntrada < '4664.69'){
                            $imposto = ($totalEntrada - 636.13) * 0.225;
                        }elseif($totalEntrada >= '4664.69'){
                            $imposto = ($totalEntrada - 869.36) * 0.27;
                        }
                        ...
                        echo "<strong>".number_format($irff,2,",",".")."</strong>";
                    ?>
                </td>
