...
<div class="w3-sidebar w3-bar-block" style="width:20%">
  <a class="w3-bar-item w3-button" style="display:block;" href="relatorio_afiliado.php?id=<?Php echo $id; ?>" target="ver_relatorio"><i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i> Associado</a>
 </div>
