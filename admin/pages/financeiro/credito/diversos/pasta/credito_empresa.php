...
<div class="w3-sidebar w3-bar-block" style="width:20%"> 
  <a class="w3-bar-item w3-button" style="display:block;" href="credito_inserir_valor.php" target="ver_relatorio">Inserir Valor</a>
  <a class="w3-bar-item w3-button" style="display:block;" href="credito_transferir.php" target="ver_relatorio">Transferência entre Contas</a>
</div>
