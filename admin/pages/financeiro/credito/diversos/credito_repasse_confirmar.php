...
$descricao = strtoupper('Repasse da Movimentação no Estabelecimento '.$loja.'');
...
$verLoja = mysql_fetch_array($sqlLoja);
	$nomeLoja = strtoupper($verLoja['estabelecimento_fantasia']);
?>

<strong>Dados Informados:</strong><br /><br />
<strong>Estabelecimento:</strong> <?Php echo "(".strtoupper($loja).") ".$nomeLoja.""; ?><br />
<strong>Conta:</strong> <?Php echo "(".strtoupper($id).") ".$nome.""; ?><br />
<strong>Valor do Cr&eacute;dito/Recarga:</strong> <?Php echo "R$ ".number_format($valor,2,",",".").""; ?><br />
<strong>Descri&ccedil;&atilde;o:</strong> <?Php echo "".$descricao.""; ?><br /><br />

<strong>Os dados acima est&atilde;o Corretos?</strong><br /><br />

<form action="credito_repasse_inserir.php" name="form" method="post">
