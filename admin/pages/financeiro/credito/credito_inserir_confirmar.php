...
if($tipo == "Recarga"){
    $tipoNome = "RECARGA EM CONTA";
}elseif($tipo == "Comissao"){
    $tipoNome = "COMISSÃO/BONIFICAÇÃO";
}
...
<div class="w3-half" style="margin-bottom:10px;"><button style="width:99%" onClick="location.href='credito_inserir_valor.php?id=<?Php echo $id; ?>&&empresa=<?Php echo $empresa; ?>'"  name="nao" class="w3-input w3-padding-16 w3-text-white w3-button w3-red btn-lg" type="reset"><i class="glyphicon glyphicon-ok"></i> Não</button></div>
